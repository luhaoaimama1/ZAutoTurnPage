...
import zone.com.retrofitlisthelper.gank2.GankAPI2;
import zone.com.retrofitlisthelper.gank2.GankImpl2;
...
public class APIController2 {
    ...
    static {
        ...
        entityList.add(new Entity(GankAPI2.class, new GankImpl2()));
    }
    ...
    public static void main(String[] args) {
        ...
        InvocationHandler handler = new HelloWorldHandler(aPIController);
