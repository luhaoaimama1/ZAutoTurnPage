 ...
 */
public class GankImpl2 extends BaseImpl<GankService2> implements GankAPI2 {

    @Override
    public CallWrapper<MeiZiData> getPics(String limit, String pageNumber,String hei) {
