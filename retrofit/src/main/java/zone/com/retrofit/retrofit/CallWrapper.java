package zone.com.retrofit.retrofit;
...
public class CallWrapper<T> implements Call<T> {
    ...
    public CallWrapper<T> delay(long delayMillis) {
        this.delayMillis = delayMillis;
        return this;
    }

    public CallWrapper<T> firstLoading(@NonNull final LoadingLayout loadingLayout) {
    ...
    public CallWrapper<T> dialog(@NonNull final Dialog dialog) {
        this.mDialog = dialog;
        return this;
    }

    public CallWrapper<T> popWindow(@NonNull final BasePopWindow popWindow) {
        this.mPopWindow = popWindow;
        return this;
    }

    public CallWrapper<T> OnLoadingListener(@NonNull OnLoadingListener loadingListener) {
